...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setJobSlug('sensio_lab_web_developer_paris');
        ...
        $job_sensio_labs->setOwner($em->merge($this->getReference('user-fabien')));
        $job_sensio_labs->setAddress($em->merge($this->getReference('address-sensio')));
        ...
        $job_sinoeujobs->setJobType($em->merge($this->getReference('type-internship')));
        ...
        $job_sinoeujobs->setJobSlug('sensio_lab_marketing_developer_paris');
        ...
        $job_sinoeujobs->setOwner($em->merge($this->getReference('user-bin')));
        $job_sinoeujobs->setAddress($em->merge($this->getReference('address-sinoeujobs')));
